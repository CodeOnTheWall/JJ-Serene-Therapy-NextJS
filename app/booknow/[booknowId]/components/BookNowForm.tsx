...
interface BookNowClientFormProps {
  bookNowClient: BookNowClientProps;
}

export default function BookNowForm({ bookNowClient }: BookNowClientFormProps) {
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>
                    ...
                    professionals to collect my personal and medical information
                    as documented above. In addition, I authorize the clinic and
                    its associated health professionals to communicate with my
                    family doctor and/or referring doctor as deemed necessary
                    for my beneficial treatment. I also understand that my
                    personal and medical information is confidential and will
                    only be disclosed to third parties with my permission.
                  </FormDescription>
                  <FormMessage />
                  <Popover>
                    <PopoverTrigger asChild>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>
                    ...
                    charged even when sessions are shortened due to late
                    arrival.
                  </FormDescription>
                  <FormMessage />
                  <Popover>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>
                    ...
                    experience short-term aggravation of symptoms or bruising as
                    a result of the treatment given. I understand that the
                    services offered are not a substitute for medical care. I
                    affirm that I have notified the therapist of all medical
                    conditions and injuries. I agree to inform the therapist of
                    any changes in my health. I understand that there shall be
                    no liability on the therapist’s part should I forget to do
                    so. By signing this release, I hereby waive and release the
                    therapist and Urban Massage & Wellness Inc. from any and all
                    liability, past, present & future relating to manual
                    osteopathy & massage therapies including (but not limited
                    to) myofascial cupping, hot stone treatments, Rapid NFR &
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>
                    ...
                    or cure any conditions and is not a replacement for standard
                    medical care. I give permission for my minor child to
                    receive treatment(s) at Urban Massage & Wellness and agree
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>
                    ...
                    responsible for the payment to the provider for any services
